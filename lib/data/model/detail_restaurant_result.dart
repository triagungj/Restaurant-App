...
DetailRestaurantsResult detailRestaurantsResultFromJson(String str) =>
    DetailRestaurantsResult.fromJson(json.decode(str));

String detailRestaurantsResultToJson(DetailRestaurantsResult data) =>
...
class DetailRestaurantsResult {
  ...
  Map<String, dynamic> toJson() => {
        "error": error,
        "message": message,
        "restaurant": detailRestaurant.toJson(),
      };
}
